...
def svmplot(x, y, xt, yt, gamma=1, plotname="svmplot.png"):
    ...
    cmap_light = ListedColormap(['r', 'g', 'b', 'c']) # Light colors for decision boundaries
    cmap_bold = ['red', 'green', 'blue', 'c'] # Bold colors for scatter plot points
    ...
    plt.title('test accuracy: {:.2f}'.format(test_accuracy))
